...
class UserProfilePage extends Component {
  ...
  updateToggleValue(toggleValue) {
    ...
    inputFieldsCopy.personalLeftInformation[
      getFieldIndex(inputFieldsCopy.personalLeftInformation, "active")
    ].defaultToggled = toggleValue;
  ...
  updateFields(data, inputFields, setState) {
    ...
    inputFieldsCopy.personalLeftInformation[
      getFieldIndex(inputFieldsCopy.personalLeftInformation, "name")
    ].defaultValue =
      data.name;
    inputFieldsCopy.personalLeftInformation[
      getFieldIndex(inputFieldsCopy.personalLeftInformation, "lastName")
    ].defaultValue =
      data.lastName;
    inputFieldsCopy.personalLeftInformation[
      getFieldIndex(inputFieldsCopy.personalLeftInformation, "birthDate")
    ].defaultValue =
      data.birthDate;
    inputFieldsCopy.personalLeftInformation[
      getFieldIndex(inputFieldsCopy.personalLeftInformation, "active")
      ...
      data.active;
    inputFieldsCopy.personalRightInformation[
      getFieldIndex(inputFieldsCopy.personalRightInformation, "address1")
    ].defaultValue =
      data.address1;
    inputFieldsCopy.personalRightInformation[
      getFieldIndex(inputFieldsCopy.personalRightInformation, "address2")
    ].defaultValue =
      data.address2;
    inputFieldsCopy.personalRightInformation[
      getFieldIndex(inputFieldsCopy.personalRightInformation, "city")
    ].defaultValue =
      data.city;
    inputFieldsCopy.personalRightInformation[
      getFieldIndex(inputFieldsCopy.personalRightInformation, "state")
    ].defaultValue =
      data.state;
    inputFieldsCopy.personalRightInformation[
      getFieldIndex(inputFieldsCopy.personalRightInformation, "country")
    ].defaultValue =
      data.country;
  ...
  handleOnChange(event, index, value) {
    let inputFieldsCopy = { ...this.state.inputFields };
    let className = document.getElementById(event.target.id).parentElement
      .className;

    if (className.indexOf("personalLeftInformation") !== -1) {
      let currentFieldIndex = getFieldIndex(
        inputFieldsCopy.personalLeftInformation,
        event.target.id
      );
      inputFieldsCopy["personalLeftInformation"][
  ...
  handleSaveUser(event, props) {
    ...
    let personalLeftInformation = validateObligatoryFields(
      this.state.inputFields.personalLeftInformation
    );
    let personalRightInformation = validateObligatoryFields(
      this.state.inputFields.personalRightInformation
    );

    if (personalLeftInformation.valid && personalRightInformation.valid) {
      let personalLeftInformation = getUserFields(
        this.state.inputFields.personalLeftInformation
      );
      let personalRightInformation = getUserFields(
        this.state.inputFields.personalRightInformation
      );
      let user = { ...personalLeftInformation, ...personalRightInformation };
      user.active = getFieldValue(
        this.state.inputFields.personalLeftInformation,
        "active"
      ).defaultToggled;
      ...
      this.setState({
        inputFields: {
          personalLeftInformation: personalLeftInformation.fieldList,
          personalRightInformation: personalRightInformation.fieldList,
          passwordField: this.state.inputFields.passwordField
        }
      });
  ...
  handlePasswordOnChange(event, index, value) {
    let inputFieldsCopy = { ...this.state.inputFields };
    let currentFieldIndex = getFieldIndex(
      inputFieldsCopy.passwordField,
      event.target.id
    );
    inputFieldsCopy["passwordField"][currentFieldIndex].defaultValue =
      event.target.value;
  ...
  handleChangePassword(event, props) {
    ...
    let passwordFields = validateObligatoryFields(
      this.state.inputFields.passwordField
    );
    ...
    if (passwordFields.valid) {
      ...
      this.setState({
        inputFields: {
          personalLeftInformation: this.state.inputFields
            .personalLeftInformation,
          personalRightInformation: this.state.inputFields
            .personalRightInformation,
          passwordField: passwordFields.fieldList
        }
      });
      addNotification({ code: ERROR_CODES.CHECK_FIELDS.code });
    }
      ...
      <div className="col-xs-12 col-md-12 UserProfilePage">
        <div className="row">
          <div className="col-xs-12 col-md-6 userProfileColumn">
            ...
            <div className="row">
              ...
              <div className="userValue">
                {getTypeName(currentUser.ownerType)}
              </div>
            </div>
            <div className="row">
              {this.state.inputFields.personalLeftInformation.map(
                (item, key) => (
                  <InputFieldComponent
                    key={key}
          ...
          <div className="col-xs-12 col-md-6 userProfileColumn">
            ...
            {this.state.inputFields.personalRightInformation.map(
              (item, key) => (
                <InputFieldComponent
                  key={key}
                  inputType={item.inputType}
        ...
        <center>
          <div className="row">
            <div className="col-xs-12 col-md-12 passwordColumn">
              {this.state.inputFields.passwordField.map((item, key) => (
                <InputFieldComponent
                  key={key}
                  inputType={item.inputType}
                  hintText={item.hintText}
