...
class NewArtistPage extends Component {
  ...
  handleOnClick(
    event,
    { clearAllNotifications, addNotification, loading, router }
  ) {
            ...
            <div className="col-xs-12 col-md-4 NewArtistForm">
              {this.state.photo !== "" ? (
                <div className="row">
                  ...
                  <center>
                    ...
                    <div className="profilePicInstruction">
                      De clic sobre la imagen en el apartado de la izquierda
              ...
              {this.state.inputFields.map((item, key) => (
                <InputFieldComponent
                  ...
                  onNewRequest={value =>
                    this.handleOnNewRequest(value, item.id)
                  }
                />
              ))}
            </div>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(NewArtistPage)
);
