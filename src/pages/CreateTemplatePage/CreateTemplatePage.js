            ...
            <div className="col-xs-12 col-md-12">
              ...
              <div className="row">
                {this.state.templateList.map((value, key) => (
                  <div className="templateEntry" key={key}>
                    <div
                      className="closeButton"
                      onClick={event => this.deleteTemplate(event, value.id)}
                    >
                      &times;
                    </div>
        ...
        <div className="row">
          <div className="col-xs-12 col-md-12">
            ...
            <div className="instructions row">
              Ingrese la información solicitada. Si no desea agregar logo y/o
              imagen de fondo, no seleccione ninguna imagen.s
            </div>
            <div className="row">
              <div className="col-xs-12 col-md-12 templateNameWrapper">
                <InputFieldComponent
                  inputType={this.state.templateName.inputType}
            ...
            <div className="row">
                ...
                <center>
                  ...
                  <DropZoneComponent
                    onDropAcceptedExtra={(imageList, image) =>
                      this.onDropAccepted(imageList, image, "logo")
                    }
                    deleteExtraImage={(imageList, image) =>
                      this.deleteExtraImage(imageList, image, "logo")
                    }
                  />
                  <InputFieldComponent
              ...
              <div className="col-xs-12 col-md-6 dropZoneWrapper">
                <center>
                  ...
                  <DropZoneComponent
                    onDropAcceptedExtra={(imageList, image) =>
                      this.onDropAccepted(imageList, image, "background")
                    }
                    deleteExtraImage={(imageList, image) =>
                      this.deleteExtraImage(imageList, image, "background")
                    }
                  />
                  <InputFieldComponent
                    inputType="selectField"
            ...
            <div className="row">
              <DefaultButton
                ...
                className="marginTop"
                onTouchTap={event =>
                  this.handleOnClickSaveButton(event, this.props)
                }
              />
            </div>
          </div>
