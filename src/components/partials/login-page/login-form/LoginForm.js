...
class LoginForm extends Component {
  ...
  handleOnClick(
    ...
    if (result.valid) {
      ...
      let usernameValue = getFieldValue(inputFieldsCopy, "username")
        .defaultValue;
      let passwordValue = md5(
        getFieldValue(inputFieldsCopy, "password").defaultValue
      );
      loading(true);
      ...
      <div className="LoginForm row">
        ...
        <div className="col-xs-12 col-md-4">
          ...
          <div className="row marginTop marginBottom">
            <center>
              <Link to="/forgotPassword" id="forgotPasswordBtn">
