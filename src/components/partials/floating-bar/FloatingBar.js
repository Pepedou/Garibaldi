...
import {
  loadTemplateConfigForArtists,
  loadTemplateConfigForArtPieces
} from "../../../redux/reducers/templates/actions";
    ...
    return (
      <div className="FloatingBar">
        {updatingCurrentArt || updatingCurrentArtist ? (
          ...
          <div>
            {this.props.checkCards.length > 0 && (
              <FloatingActionButton
                style={style}
                backgroundColor={blue700}
                onTouchTap={event =>
                  this.exportToPdf(event, checkCards, this.props)
                }
              >
                <SvgIcon>
