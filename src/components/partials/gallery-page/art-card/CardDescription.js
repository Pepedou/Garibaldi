      ...
      <div className="CardDescription row">
        <Category
          category={{
            ...
            categoryValue: getDetailValue(
              artCardInformation.detail.measurements.value
            ),
            editableName: false,
            editableValue: true,
        ...
        <Category
          category={{
            ...
            categoryValue: getDetailValue(
              artCardInformation.detail.technique.value
            ),
            editableName: false,
            editableValue: true,
        ...
        <Category
          category={{
            ...
            categoryName: "Serie",
            categoryValue: getDetailValue(
              artCardInformation.detail.series.value
            ),
            editableName: false,
            editableValue: true,
            propertyName: "series"
        ...
        <Category
          category={{
            ...
            categoryName: "Tiraje",
            categoryValue: getDetailValue(
              artCardInformation.detail.tiraje.value
            ),
            editableName: false,
            editableValue: true,
            propertyName: "tiraje"
        ...
        <Category
          category={{
            ...
            categoryName: "Año",
            categoryValue: getDetailValue(
              artCardInformation.detail.year.value.toString()
            ),
            editableName: false,
            editableValue: true,
            propertyName: "year"
        ...
        <Category
          category={{
            ...
            categoryName: "Precio",
            categoryValue: getDetailValue(
              artCardInformation.detail.price.value
            ),
            editableName: false,
            editableValue: true,
            propertyName: "price"
          ...
          validate={handleCategoryValidation}
        />
        {artCardInformation.categories.map((item, key) => (
          <Category
            key={key}
            position={key}
            category={{
