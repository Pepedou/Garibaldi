...
class DropZoneComponent extends Component {
  ...
  deleteImage(event, image, { deleteExtraImage }) {
    ...
    imageListCopy = [
      ...imageListCopy.slice(0, index),
      ...imageListCopy.slice(index + 1)
    ];
    ...
    return this.state.loading ? (
      ...
      <div className="DropZoneComponent">
        <div className="linkWrapper">
          ¿Problemas al subir tu imagen? Intenta con{" "}
          <a
            href="https://www.befunky.com/"
            target="_blank"
            rel="noopener noreferrer"
            className="dropzoneLink"
          >
            esta
          </a>{" "}
          herramienta.
        ...
        >
          <div className="DropZoneSection-message">
            ...
            <p>
              Intente colocar la imagen aquí, o haga clic para seleccionar la
          ...
          <center>
            <div className="PreviewSection">
              {this.state.imageList.map((image, key) => (
                <div className={previewImageClass} key={key}>
                  <div className="row">
                    <a
                      className="CloseDropZonebtn"
                      onClick={event =>
                        this.deleteImage(event, image, this.props)
                      }
                    >
                      &times;
                    </a>
                  ...
                  <img
                    ...
                    onClick={event =>
                      this.onClickProfilePic(event, image, this.props)
                    }
                  />
                </div>
              ))}
