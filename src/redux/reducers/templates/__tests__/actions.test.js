...
describe.skip("Templates Actions", () => {
  ...
  it("should handle save and reset actions dispatching", () => {
    ...
    const dispacthes = Thunk(actions.saveAndRestTemplate).execute(
      templateToSave
    );
  ...
  it("should dispatch config loading for export artists", async () => {
    ...
    ExportTemplatesServices.getAll.mockReturnValueOnce(
    ...
    ArtistsServices.detailFor.mockReturnValueOnce(
      new Promise((resolve, reject) => {
        resolve({
          details: [
            {
    ...
    const dispatches = await Thunk(
      actions.loadTemplateConfigForArtists
    ).execute(artistsToExport);
  ...
  it("should dispatch config loading for export artpieces", async () => {
    ...
    ArtPiecesServices.detailFor.mockReturnValueOnce(
      new Promise((resolve, reject) => {
        resolve({
          details: [
            {
              ...
              description: "",
              source:
                "https://res.cloudinary.com/zamancer/image/upload/v1509552431/ffqevw7q4fc7w63izw2r.jpg",
              artistId: "59f680cc9373be0004b3f067",
              images: {
                thumbnail:
                  "https://res.cloudinary.com/zamancer/image/upload/c_fill,g_west,h_150,w_150/v1509552431/ffqevw7q4fc7w63izw2r.jpg",
                standard:
                  "https://res.cloudinary.com/zamancer/image/upload/v1509552431/ffqevw7q4fc7w63izw2r.jpg"
              },
              categories: [
    ...
    const dispatches = await Thunk(
      actions.loadTemplateConfigForArtPieces
    ).execute(artPiecesToExport);
