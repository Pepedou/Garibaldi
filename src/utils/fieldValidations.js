...
export let getFieldIndex = (fieldList, fieldId) =>
  fieldList.findIndex(field => field.id === fieldId);
export let getFieldValue = (fieldList, fieldId) =>
  fieldList.find(field => field.id === fieldId);
...
export let getDetailValue = value =>
  value === "" || !value ? "Valor no definido" : value;
