...
export let ERROR_CODES = {
    ...
    REQUIRED_FIELDS: {code: "REQUIRED_FIELDS", message: "Ingrese la información de los campos marcados en rojo"},
    NO_RESULTS_FOUND: {code: "NO_RESULTS_FOUND", message: "No hay resultados para la búsqueda especificada"},
    NO_CARDS_FOUND: {code: "NO_CARDS_FOUND", message: "No se encontraron tarjetas para esta página"},
    CHECK_FIELDS: {code: "CHECK_FIELDS", message: "Verifique la información de los campos marcados en rojo"},
    WRONG_IMAGE: {code: "WRONG_IMAGE", message: "La imagen seleccionada no cumple con las características requeridas"},
    CANT_SAVE_IMAGE: {code: "CANT_SAVE_IMAGE", message: "No se pudo guardar la imagen"},
    REQUIRED_FIELDS_NEW_ART: {code: "REQUIRED_FIELDS_NEW_ART", message: "Seleccione la imagen de la obra e ingrese la información de los campos marcados en rojo (en los campos con catálogos asegurese de seleccionar una opción correcta)"}
}
...
export let handleError = (dispatch, error, notificationType, contentType) => {
    ...
    dispatch({type: constants.ADD_NOTIFICATION, notification: {type, contentType: "text", message: getErrorMessage(error)}})
}